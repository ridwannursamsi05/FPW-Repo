            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="container mx-auto mt-5">
                        ...
                        <h2 class="mb-5 text-2xl font-bold bg-gray-50 border border-gray-200 rounded-lg shadow-sm px-4 py-3">Edit Product</h2>
                        ...
                        <form action="{{ route('product-update', $product->id) }}" method="POST" class="space-y-4">
                            ...
                            <div class="form-group">
                                ...
                                <select id="unit" name="unit"
                                    ...
                                    <option value="kg" {{ $product->unit == 'kg' ? 'selected' : '' }}>Kilogram (kg)
                                    </option>
                                    <option value="ltr" {{ $product->unit == 'ltr' ? 'selected' : '' }}>Liter (ltr)
                                    </option>
