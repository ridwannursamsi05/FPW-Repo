...
// Create Form
Route::get('/product/create', [ProductController::class, 'create'])->name('product-create'); // method get tanpa parameter request
Route::post('/product', [ProductController::class, 'store'])->name('product-store'); // method post dengan parameter request
