    ...
    <div class="container p-4 mx-auto">
        <div class="overflow-x-auto">
            ...
            <a href="{{ route('product-create')}}">
                <button
                    class="px-4 py-2 text-white bg-green-500 border border-green-500 rounded-lg shadow-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 mb-4">
                    Add product data
                </button>
            </a>
            ...
            <a href="{{ route('product-export-excel')}}">
                <button
                    class="float-right px-4 py-2 text-white bg-green-500 border border-green-500 rounded-lg shadow-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 mb-4">
                    Create Excel
                </button>
            </a>
